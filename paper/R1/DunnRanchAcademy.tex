...
As such, the workshop was formally run as an Incident just as any other prescribed fire or wildfire response would be conducted. Prescribed Fire Training Exchanges (TREX) are structurally similar, with a core group of instructors (cadre) and each participant serving as both a trainee as well as trainer depending on their individual skillset and qualifications.   
