\documentclass[fire,casereport,submit,moreauthors,pdftex]{Definitions/mdpi} 
...
$^{2}$ \quad Tallgrass Prairie and Oak Savanna Fire Science Consortium, University of Wisconsin, Madison, WI 53715 USA \\
$^{3}$ \quad The Nature Conservancy, Missouri Field Office, St. Louis, MO 63144 USA; rgauger@tnc.org \\
$^{4}$ \quad US Fish and Wildlife Service, Big Muddy National Fish and Wildlife Refuge, Booneville, MO, USA \\
...
% Keywords
\keyword{\#FireScienceDIY, \#NerdTREX, Learn and burn, Wildland fire science literacy}
...
But some local fire departments bristle at the constraints of the ICS \citep{jensen2011}, and the hierarchical structure of training, certification, and qualification for positions within the ICS can create a barrier to allowing otherwise experienced personnel to conduct prescribed burns \citep{spencer2015}.
