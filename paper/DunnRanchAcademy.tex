...
% Keywords
\keyword{\#FireScienceDIY, Learn and burn, Wildland fire science literacy}
...
\caption{The wallet card figure from \citet{mcgranahan2018} that describes the components of the fire environment most relevant to two arenas of the wildland fire professional: In the field, and in the office.}
\label{WalletCard}
\end{figure}
...
The Hands-on Fire Science Methods Workshop was held 14-18 March 2022 at The Nature Conservancy's Dunn Ranch Prairie near Eagleville, Missouri, USA (Fig.~\ref{\label{DunnRanch}).
...
\begin{quote}
Lighting several fires is the only way to learn what environmental and fuel conditons are required to produce desired fire behavior. (\citet{mcpherson1986})
\end{quote}
